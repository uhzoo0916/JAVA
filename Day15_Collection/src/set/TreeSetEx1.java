...
class TreeSetEx1 {
	public static void main(String[] args) {
		...
		System.out.println("result1 : " + set.subSet(from, to)); //상한값 포함, 하한값 미포함 이므로 b 안포함
		System.out.println("result2 : " + set.subSet(from, to + "zzz")); //zzz 넣으면 b 포함됨 
	}
}